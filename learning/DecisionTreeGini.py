...
if __name__ == "__main__" :
    ...
    model = DecisionTree.trainClassifier(training, categoricalFeaturesInfo={}, impurity="gini", maxDepth=5, numClasses=2)
    ...
    write_result(num_pos, num_neg, accuracy = accuracy, f1 = f1, name = "Decision Tree (Gini)")