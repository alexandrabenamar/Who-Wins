...
def calcul_metriques(data):
	...
	data_f.to_csv(path_or_buf="data.sentiment.output2.csv",sep=';',columns=["pos","neg","none","nb_words","-neg+posM0","weight_n_posM1","weight_n_posM2","weight_n_posM3"],header=True,index =True,index_label="id_tweet",mode='w')
	#print(data_f)
	print("\nSee "+"data.sentiment.output2.csv")
